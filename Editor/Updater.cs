...
public class Updater : Editor
{
    ...
    private const string PackageName = "com.popcron.builder";
    private const string PackageURL = "https://raw.githubusercontent.com/popcron/builder/master/package.json";
    private const string CanUpdateKey = "Popcron.Builder.CanUpdate";
    private const string CheckForUpdateText = "Popcron/Builder/Check for updates";
    private const string UpdateText = "Popcron/Builder/Update";
